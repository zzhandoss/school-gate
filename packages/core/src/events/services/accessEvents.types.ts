...
import type { AccessEventsRepo } from "../repos/accessEvents.repo.js";

export type AccessEventsService = {
    ...
    withTx(tx: unknown): AccessEventsService;
};

export type AccessEventsServiceDeps = {
